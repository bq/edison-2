...
{0xa1,0x80},
{0xa2,0x80},
   #elif defined(CONFIG_MALATA_D1014)||defined(CONFIG_MALATA_D8009)
     // 0x17 0x14
      {0xfe, 0x00},
      {0xae, 0x78},
	{0xfe, 0x01},
	...
	{0xa1, 0x80},
	{0xa2, 0x80},
	#elif defined(CONFIG_MALATA_D1013)||defined(CONFIG_MALATA_D1025)
	{0xfe, 0x01},
	{0xc2, 0x15},
{0xc3, 0x0c},  
{0xc4, 0x04}, 
...
{0xa2, 0x80},
	...
	{0x4d,0x62},  //
	{0x4e,0x20},//20//20  //
	{0x4e,0x00},//20//20//10//20//04//10  //  tl84 10
	{0x4e,0x00},//20//00//20
	{0x4e,0x00},//00//20
	{0x4d,0x70},  //
	{0x4e,0x00},  //
