...
#define SENSOR_NAME sid130B_back
...
static int flash_on_off =0;   // honghaishen_test hhs_0111
...
{0x04, 0x00},  //gb-selset
{0x05, 0x0f}, 	//ga-still
{0x06, 0x8e},  //gb-preview
{0x07, 0x88},             
{0x08, 0x22},  //0xa2 pll off
{0x09, 0x12}, 	//ga-still 24-32 
{0x0a, 0x12},  //gb-preview 24-32 
{0x10, 0x13}, 	 
{0x11, 0x01},  
{0x12, 0x8a},  
{0x13, 0x1a}, 
...
{0x17, 0xc4}, 
{0x1c, 0x0e},             
{0x34, 0x60},  //64 //gb-preview
{0x35, 0x3c},  //3c //ga-still 
{0x36, 0x28},               
{0x40, 0x40},  //40 							
{0x41, 0x28}, 
{0x42, 0x20}, 
...
{0x27, 0x2f}, //0x4b	     
{0x00, 0x01}, //ae block
{0x34, 0x60}, //0x64 //gb-preview
{0x35, 0x3c}, //0x32 //ga-still 
{0x36, 0x28}, //0x26        
{0x00, 0x03}, //idp3 block
...
static  struct v4l2_queryctrl sensor_controls[] =
{
	...
	#if CONFIG_SENSOR_Flash
	{
     ...
     // honghaishen_test hhs_1224
   {        .id		= V4L2_CID_OPEN_FLASH,        .type		= V4L2_CTRL_TYPE_MENU,        .name		= "Flash status",        .minimum	= 0,        .maximum	= 1,        .step		= 1,        .default_value = 0,    },
	#endif
};
...
static int sensor_init(struct v4l2_subdev *sd, u32 val)
{
	...
	if (sensor_task_lock(client,1)<0)
		goto sensor_INIT_ERR;
    ret = sensor_write(client, 0x00, 0x00);
    if (ret != 0)
    {
...
static int sensor_s_fmt(struct v4l2_subdev *sd, struct v4l2_mbus_framefmt *mf)
{
	...
	if(flash_on_off == 1)
	{
		...
		hrtimer_start(&(flash_off_timer.timer),ktime_set(0, 150*1000*1200),HRTIMER_MODE_REL);
	}
...
static int sensor_g_ext_control(struct soc_camera_device *icd , struct v4l2_ext_control *ext_ctrl)
{
	...
	case V4L2_CID_OPEN_FLASH:		{	         sensor_write(client, 0x00, 0x01);
		 sensor_read(client, 0x32, &y_value);
		 if(y_value > 62)
		 	ext_ctrl ->value = 1;
		 else 		 	ext_ctrl->value =0;	
...
static struct v4l2_subdev_video_ops sensor_subdev_video_ops = {
	...
	.s_stream = sensor_s_stream,  // honghaishen_test hhs_0111
};
