...
static const struct usb_device_id option_ids[] = {
  ...
  { USB_DEVICE(USI_UNA_VENDOR_ID, USI_UNAP_PRODUCT_5COM) },
	...
	{ USB_DEVICE_AND_INTERFACE_INFO(HUAWEI_VENDOR_ID, HUAWEI_PRODUCT_K4605, 0xff, 0xff, 0xff),
		.driver_info = (kernel_ulong_t) &huawei_cdc12_blacklist },
	{ USB_DEVICE_AND_INTERFACE_INFO(HUAWEI_VENDOR_ID, 0x1570, 0xff, 0xff, 0xff),
		.driver_info = (kernel_ulong_t) &huawei_cdc12_blacklist },/*M-MT:HUAWEI LTE*/
   { USB_VENDOR_AND_INTERFACE_INFO(HUAWEI_VENDOR_ID, 0x02, 0x02, 0xff) },//added by zengshanbin
   { USB_VENDOR_AND_INTERFACE_INFO(HUAWEI_VENDOR_ID, 0xff, 0xff, 0xff) },//added by zengshanbin
...
//xxh
 ...
 //  { USB_DEVICE(0x21F5, 0x2009) },
   ...
   { USB_DEVICE(0x12d1,0x1570)},/*M-MT:HUAWEI LTE*/
...
static struct usb_driver option_driver = {
	...
	#if defined(CONFIG_ME906E) || defined(CONFIG_MT6229_UNAP)
	.reset_resume     = usb_serial_resume,/*M-MT:HUAWEI LTE*/
	#endif
			...
			const struct usb_device_id *id)
{
	...
	if (serial->dev->descriptor.idVendor == SAMSUNG_VENDOR_ID &&
		...
		return -ENODEV;
  if (serial->dev->descriptor.idProduct == MEDIATEK_PRODUCT_DC_4COM) {
    if (0 != (serial->dev->config->desc.bmAttributes & 0x20)) {
      printk("%s, USI UNA+ enable auto suspend\n", __FUNCTION__);
      usb_enable_autosuspend(serial->dev);      //使能3G模组的autosuspend功能
      device_init_wakeup(&serial->dev->dev, 1); //允许3G模组二级睡眠唤醒系统
    }
  }
	...
	/*Don't bind network interface on USI NNA modem
