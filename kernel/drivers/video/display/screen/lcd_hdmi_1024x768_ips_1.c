...
//#define S_OUT_CLK		SCALE_RATE(148500000,108000000) //m=16 n=9 no=2
#define S_OUT_CLK   SCALE_RATE(148500000,102093750) 
#define S_H_PW			213
#define S_H_BP			400
#define S_H_VD			1024
#define S_H_FP			500
...
//720*480*60
#define S5_OUT_CLK		SCALE_RATE(27000000,99692307)  //m=16 n=2 no=2 
#define S5_H_PW			580
#define S5_H_BP			400
#define S5_H_VD			1024
#define S5_H_FP			500
