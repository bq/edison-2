...
#define OUT_CLK			 55000000        // 65000000
...
/* scaler Timing    */
//1920*1080*60
#define S_OUT_CLK		SCALE_RATE(148500000,41250000) //m=20 n=9 no=8
#define S_H_PW			30
#define S_H_BP			30
#define S_H_VD			1024
#define S_H_FP			16
...
//1920*1080*50
#define S1_OUT_CLK		SCALE_RATE(148500000,41250000)  //m=16 n=11 no=4 
#define S1_H_PW			100
#define S1_H_BP			100
#define S1_H_VD			1024
#define S1_H_FP			96
...
//1280*720*60
#define S2_OUT_CLK		SCALE_RATE(74250000,41250000)  //m=32 n=9 no=4
#define S2_H_PW			30
#define S2_H_BP			30
#define S2_H_VD			1024
#define S2_H_FP			16
...
#define S3_OUT_CLK		SCALE_RATE(74250000,41250000)   // m=32 n=11 no=4 
#define S3_H_PW			100
#define S3_H_BP			100
#define S3_H_VD			1024
#define S3_H_FP			96
...
//720*576*50
#define S4_OUT_CLK		SCALE_RATE(27000000,42187500)  //m=145 n=9 no=8 
#define S4_H_PW			100
#define S4_H_BP			100
#define S4_H_VD			1024
#define S4_H_FP			72
...
//720*480*60
#define S5_OUT_CLK		SCALE_RATE(27000000,45000000)  //m=32 n=3 no=4 
#define S5_H_PW			30
#define S5_H_BP			30
#define S5_H_VD			1024
#define S5_H_FP			60
