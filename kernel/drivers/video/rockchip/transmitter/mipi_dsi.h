...
struct ql_vx5a3b_t {
	u32 id;
    struct reset_t reset;
    struct power_t lcd_en;
    struct power_t vcc_lcd; //vcc_io //v3p3_vx5 //3.3v
    struct power_t vrgb_io; //vcc_18 //v1p8_vx5 //1.8v
    struct power_t vdd_log; //v1p2_vx5 //cannot control 1.2v
	int (*gpio_init)(void *);
	int (*gpio_deinit)(void *);
    struct i2c_client *client;
	int (*power_up)(void);
