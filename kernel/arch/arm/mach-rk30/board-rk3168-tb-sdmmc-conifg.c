...
#define RK29SDK_SD_CARD_INSERT_LEVEL_H            GPIO_HIGH       // set the voltage of insert-card. Please pay attention to the default setting.
//wake up host gpio
...
#elif defined(CONFIG_BCM4330) || defined(CONFIG_BCM4329) || defined(CONFIG_RKWIFI) || defined(CONFIG_RTL8723BS) || defined (CONFIG_GB86302I)
	#define RK30SDK_WIFI_GPIO_POWER_N               RK30_PIN3_PD0                 
    #define RK30SDK_WIFI_GPIO_POWER_ENABLE_VALUE    GPIO_HIGH
#if !defined(CONFIG_RTL8723BS)
...
#elif defined(CONFIG_MT5931_MT6622)||defined(CONFIG_MT5931) || defined (CONFIG_GB86302I)
    voltage = 1800 ; //power 1800V
#elif defined(CONFIG_ESP8089) || defined(CONFIG_RTL8723BS)
