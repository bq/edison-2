...
static struct rt5025_power_data rt5025_power_data = {
	...
	.CHGControl6 = {
		.bitfield = {
			.IPREC = RT5025_IPREC_20P,//precharge current
			.IEOC = RT5025_IEOC_20P,//termination charge current
...
#if defined(CONFIG_BATTERY_BTUCNRD005)||defined(CONFIG_BATTERY_BTD014L)||defined(CONFIG_BATTERY_BT_D004)
#if defined(CONFIG_BATTERY_BTUCNRD005)
#define CHARGE_MAX_CURRENT	1800
#elif defined(CONFIG_BATTERY_BTD014L)
#define CHARGE_MAX_CURRENT	2000
#else
#define CHARGE_MAX_CURRENT	2000
#endif
//temp unit: 'c*10 degree
static int jeita_temp[4] = { -50, 150, 500, 550};
			     //-10',  0',   10', 20',   45'   55'   50',  60'
static u8 jeita_scalar[8] = { 0x33, 0x2E, 0x28, 0x22, 0x14, 0x10, 0x12, 0x0E};
//cc unit: xxx mA  Charging regulation current (default 1.8A)
static int jeita_temp_cc[][5] = {
				{ 500,  500,  500,  500,  500},   // not plugin
				{   0,  500,  500,  500,    0},   // normal USB
				{   0,  1000, CHARGE_MAX_CURRENT, 1000,   0},   // USB charger
				{   0,  1000, CHARGE_MAX_CURRENT, 1000,   0}    // AC Adapter
};
//cv unit: xxx mV Battery regulation voltage
static int jeita_temp_cv[][5] = {
				{ 4150, 4150, 4200, 4150, 4150},  // not plugin
				{ 4150, 4150, 4200, 4150, 4150},  // normal USB
				{ 4150, 4150, 4200, 4150, 4150},  // USB charger
				{ 4150, 4150, 4200, 4150, 4150}   // AC Adapter
};
#else
//temp unit: 'c*10 degree
