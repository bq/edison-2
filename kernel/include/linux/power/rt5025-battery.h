...
#elif defined(CONFIG_BATTERY_BTUCNRD005)
#include <linux/power/BTUCNRD005-3800MA.h>
#elif defined(CONFIG_BATTERY_BTD014L)
#include <linux/power/BT-D014L-6400MA.h>
#elif defined(CONFIG_BATTERY_BT_D004)
#include <linux/power/BT-D004-4300MA.h>
#else
