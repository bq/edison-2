...
/* CHARGE Mode Current Config */
#define CHARGE_CURRENT_CONFIG_1024MA		0x08
#define CHARGE_CURRENT_CONFIG_2048MA		0x18
#define CHARGE_CURRENT_CONFIG_3072MA		0x28
#define CHARGE_CURRENT_CONFIG_4096MA		0x38
#define CHARGE_CURRENT_CONFIG_4544MA		0x3F
#define CHARGE_CURRENT_CONFIG_OFFSET		2
#define CHARGE_CURRENT_CONFIG_MASK		0x3F
/*IR Compensation Resistor Setting*/
#define IR_RESISTOR_0OHM		0
#define IR_RESISTOR_10OHM		1
#define IR_RESISTOR_20OHM		2
#define IR_RESISTOR_30OHM		3
#define IR_RESISTOR_40OHM		4
#define IR_RESISTOR_50OHM		5
#define IR_RESISTOR_60OHM		6
#define IR_RESISTOR_70OHM		7
#define IR_RESISTOR_OFFSET		5
#define IR_RESISTOR_MASK		0x3
/*IR Compensation Voltage Clamp*/
#define IR_VOLTAGE_CLAMP_0MV		0
#define IR_VOLTAGE_CLAMP_16MV		1
#define IR_VOLTAGE_CLAMP_32MV		2
#define IR_VOLTAGE_CLAMP_48MV		3
#define IR_VOLTAGE_CLAMP_64MV		4
#define IR_VOLTAGE_CLAMP_80MV		5
#define IR_VOLTAGE_CLAMP_96MV		6
#define IR_VOLTAGE_CLAMP_112MV		7
#define IR_VOLTAGE_CLAMP_OFFSET	2
#define IR_VOLTAGE_CLAMP_MASK		0x3
