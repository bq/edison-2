...
#define RT5025_DRV_VER	   "1.0.12_R"
...
//	ktime_t	last_event;
  ...
  bool edv_flag;//empty voltage flag
  bool edv_detection;//empty voltage warning
  u8 edv_cnt;//empty voltage count
  
  bool tp_flag;//charge full flag
  u8 tp_cnt;
